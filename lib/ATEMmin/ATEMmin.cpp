...
void ATEMmin::_parseGetCommands(const char *cmdStr)
{
	...
	{
		memcpy(_ATEMmodelname, _packetBuffer, 44);
	...
	else if (!strcmp_P(cmdStr, PSTR("TrPs")))
	{
		...
		if (mE <= 1)
		{
			...
			{
				Serial.print(F("atemTransitionPosition[mE="));
				Serial.print(mE);
				Serial.print(F("] = "));
	...
	else if (!strcmp_P(cmdStr, PSTR("KeOn")))
	{
		...
		if (mE <= 1 && keyer <= 3)
		{
			...
			{
				Serial.print(F("atemKeyerOnAirEnabled[mE="));
				Serial.print(mE);
				Serial.print(F("][keyer="));
				Serial.print(keyer);
				Serial.print(F("] = "));
	...
	else if (!strcmp_P(cmdStr, PSTR("DskS")))
	{
		...
		if (keyer <= 1)
		{
			...
			{
				Serial.print(F("atemDownstreamKeyerInTransition[keyer="));
				Serial.print(keyer);
				Serial.print(F("] = "));
			...
			{
				Serial.print(F("atemDownstreamKeyerIsAutoTransitioning[keyer="));
				Serial.print(keyer);
				Serial.print(F("] = "));
			...
			{
				Serial.print(F("atemDownstreamKeyerFramesRemaining[keyer="));
				Serial.print(keyer);
				Serial.print(F("] = "));
	...
	else if (!strcmp_P(cmdStr, PSTR("FtbS")))
	{
		...
		if (mE <= 1)
		{
			...
			{
				Serial.print(F("atemFadeToBlackStateInTransition[mE="));
				Serial.print(mE);
				Serial.print(F("] = "));
			...
			{
				Serial.print(F("atemFadeToBlackStateFramesRemaining[mE="));
				Serial.print(mE);
				Serial.print(F("] = "));
	...
	else if (!strcmp_P(cmdStr, PSTR("TlIn")))
	{
...
*/
	...
	// PSK Add for input properties
	else if (!strcmp_P(cmdStr, PSTR("InPr")))
	{
		uint16_t videoSource = word(_packetBuffer[0], _packetBuffer[1]);
		if (getVideoSrcIndex(videoSource) < INPR_MAX_INPUTS)
		{	
			atemInputInitialized[getVideoSrcIndex(videoSource)] = true;
			...
			{
				Serial.print(F("atemInputLongName[getVideoSrcIndex(videoSource)="));
				Serial.print(getVideoSrcIndex(videoSource));
				Serial.print(F("] = "));
			...
			if ((_serialOutput == 0x80 && hasInitialized()) || (_serialOutput == 0x81 && !hasInitialized()))
			{
				Serial.print(F("atemInputShortName[getVideoSrcIndex(videoSource)="));
				Serial.print(getVideoSrcIndex(videoSource));
				Serial.print(F("] = "));
...
/*
			...
			{
				Serial.print(F("atemInputAvailableExternalPortTypes[getVideoSrcIndex(videoSource)="));
				Serial.print(getVideoSrcIndex(videoSource));
				Serial.print(F("] = "));
...
/*
			...
			{
				Serial.print(F("atemInputExternalPortType[getVideoSrcIndex(videoSource)="));
				Serial.print(getVideoSrcIndex(videoSource));
				Serial.print(F("] = "));
...
*/
			...
			{
				Serial.print(F("atemInputPortType[getVideoSrcIndex(videoSource)="));
				Serial.print(getVideoSrcIndex(videoSource));
				Serial.print(F("] = "));
...
/*
			...
			{
				Serial.print(F("atemInputAvailability[getVideoSrcIndex(videoSource)="));
				Serial.print(getVideoSrcIndex(videoSource));
				Serial.print(F("] = "));
...
/*
			...
			{
				Serial.print(F("atemInputMEAvailability[getVideoSrcIndex(videoSource)="));
				Serial.print(getVideoSrcIndex(videoSource));
				Serial.print(F("] = "));
...
#endif
/*
		printf("InPr: %d %d %s %s %d\n", videoSource,getVideoSrcIndex(videoSource),
			atemInputLongName[getVideoSrcIndex(videoSource)],
			atemInputShortName[getVideoSrcIndex(videoSource)],
			atemInputPortType[getVideoSrcIndex(videoSource)]);
*/
		}
	}
 ...
 * videoSource 	(See video source list)
 */
char *ATEMmin::getInputLongName(uint16_t videoSource)
{
 ...
 * videoSource 	(See video source list)
 */
char *ATEMmin::getInputShortName(uint16_t videoSource)
{
 ...
 * videoSource 	(See video source list)
 */
uint8_t ATEMmin::getInputPortType(uint16_t videoSource)
{
 ...
 * videoSource 	(See video source list)
 */
bool ATEMmin::isInputInitialized(uint16_t videoSource)
{
	return atemInputInitialized[getVideoSrcIndex(videoSource)];
}
